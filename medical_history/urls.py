...
from medical_history.views import AppointmentViewSet, PatientViewSet, \
    ...
    SymptomViewSet, TreatmentMachineViewSet, TreatmentModeViewSet, PatientDiagnosticViewSet, PatientTreatmentViewSet, \
